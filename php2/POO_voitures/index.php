...
require "Voiture.php";
    ...
    // - Couleurs différentes proches (selon pool) pour chaque <i> landscape 
    ...
    echo "<div id='wrapper'><div id='landscapeDiv'><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'></i><i class='fa-solid icon'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid icon'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'><i class='fa-solid icon'></i></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-industry'></i><i class='fa-solid icon'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-school'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid icon'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-industry'></i><i class='fa-solid fa-city'></i><i class='fa-solid fa-hotel'></i><i class='fa-solid fa-building'></i><i class='fa-solid fa-city'></i></div></div>";

    echo "<br><div id='miniJeuDiv1'><div id='carPathDiv'><i id='carSmoke' class='fa-brands fa-cloudversify'></i><i class='fa-solid fa-car-side' id='carIcon'></i>......................................................................................................................................</div><span style='letter-spacing:-7px;'><i class='fa-solid fa-flag-checkered' style='position:relative; font-size:140%; bottom:4px;'></i><i class='fa-solid fa-flag-checkered' style='position:relative; font-size:140%; top:5px;'></i></span></div><br><span id='underRoad' style='position:relative; bottom:26px; left:22px;'>&nbsp;....................................................................................................................................................</span>";
...
echo "<br><span style=\"color:red;\">2023-02-09 23:21:32:</span> " . $v5->demarrer();echo "<br><span style=\"color:red;\">2023-02-09 23:21:34:</span> " . $v5->accelerer(10) . " "  . $v5->printVitesseActuelle();echo "<br><span style=\"color:red;\">2023-02-10 19:21:13:</span> " . $v5->accelerer(10) . " "  . $v5->printVitesseActuelle();echo "<br><span style=\"color:red;\">2023-02-10 19:21:15:</span> " . $v5->accelerer(10) . " "  . $v5->printVitesseActuelle();echo "<br><span style=\"color:red;\">2023-02-10 19:23:51:</span> " . $v5->accelerer(10) . " "  . $v5->printVitesseActuelle();echo "<br><span style=\"color:red;\">2023-02-10 19:33:09:</span> " . $v5->demarrer();